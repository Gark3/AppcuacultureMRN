<template>
  ...
  <section class="card">
    <div class="card__header">
      ...
      <p class="card__sub">Filtra y registra <strong>tratamientos</strong> para tus siembras activas.</p>
    </div>
  ...
  <section class="container container--fluid">
          ...
          >
            ...
            <div class="mt-2">
              <button
                ...
                @click="registrarTratamiento(s.id_siembra)"
    ...
    <!-- Mensajes -->
    <p v-if="!cargando && !siembrasFiltradas.length" class="text-muted mt-2">
      No se encontraron siembras que coincidan con la búsqueda.
    </p>
    <p v-if="cargando" class="text-muted mt-2">Cargando siembras…</p>
  </section>
</template>
...
export default {
  name: 'SiembrasActivasTratamientos',
  data() {
    return {
      siembras: [],
      busqueda: '',
  ...
  methods: {
    ...
    registrarTratamiento(id) {
      this.$router.push(`/producción/tratamientos/registro/${id}`);
    },
