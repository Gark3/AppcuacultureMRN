<template>
  ...
  <section class="card">
    <div class="card__header">
      ...
      <p class="card__sub">Filtra y registra el <strong>crecimiento</strong> de tus siembras activas.</p>
    </div>
      ...
      >
        ...
        <div class="mt-3">
          <button
            ...
            @click="registrarCrecimiento(siembra.id_siembra)"
            title="Registrar Crecimiento"
          >
...
export default {
  name: 'SiembrasActivasCrecimiento',
  data() {
    return {
      siembras: [],
      busqueda: ''
  ...
  methods: {
    ...
    registrarCrecimiento(id) {
      this.$router.push(`/producción/crecimiento/registro/${id}`);
    }
  },
  mounted() {
