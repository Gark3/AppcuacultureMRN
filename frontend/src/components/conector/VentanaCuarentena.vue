<template>
  ...
  <section class="card">
    <div class="card__header">
      ...
      <p class="card__sub">Filtra y registra la <strong>cuarentena</strong> de tus siembras activas.</p>
    </div>
      ...
      >
        ...
        <div class="mt-3">
          <button
            ...
            @click="registrarCuarentena(siembra.id_siembra)"
            title="Registrar Cuarentena"
          >
...
export default {
  name: 'SiembrasActivasCuarentena',
  data() {
    return {
      siembras: [],
      busqueda: ''
  ...
  methods: {
    ...
    registrarCuarentena(id) {
      this.$router.push(`/producción/cuarentena/registro/${id}`);
    }
  },
  mounted() {
