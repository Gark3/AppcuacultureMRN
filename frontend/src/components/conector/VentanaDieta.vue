<template>
  ...
  <section class="card">
    <div class="card__header">
      ...
      <p class="card__sub">Filtra y registra la <strong>dieta</strong> de tus siembras activas.</p>
    </div>
          ...
          >
            ...
            <div class="mt-2">
              <button
                ...
                @click="registrarDieta(s.id_siembra)"
...
export default {
  ...
  methods: {
    ...
    registrarDieta(id) {
      this.$router.push(`/producción/dieta/registro/${id}`);
    },
